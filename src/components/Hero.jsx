            ...
            <div className="container py-6 px-6 mx-auto">
                <div className="max-md:mt-40 mt-14 text-center">
                    <motion.h1
                        ...
                        className="text-center text-8xl max-w-5xl max-md:text-5xl mx-auto font-TitlingGothicFB text-white tracking-wider leading-none uppercase">United by Metal. Streaming, Reinvented.
                    </motion.h1>
                    <motion.p
                        initial={{ y: 70, opacity: 0, }}
                        animate={{ y: 0, opacity: 1, }}
                        ...
                        One for your eyes. One for your ears.
                        And both for the scene.
                    </motion.p>
                    <br />
                    <motion.p
                        initial={{ y: 70, opacity: 0, }}
                    ...
                    <motion.div
                        ...
                        <div className="flex items-center justify-center">
                            <p className="w-32 relative mt-16 max-md:mt-8 max-md:text-sm font-Poppins-Regular text-white text-lg text-center">Exclusively for <img
                                src={TFLogo} className="p-2" alt="" />Customers</p>
